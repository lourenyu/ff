...
namespace __pythran_brief_cy
{
  ...
  {
    {
      long  __target159085104 = std::get<0>(pythonic::builtins::getattr(pythonic::types::attr::SHAPE{}, pos0));
      for (long  p=0L; p < __target159085104; p += 1L)
      {
        ...
        {
          long  __target159086064 = std::get<0>(pythonic::builtins::getattr(pythonic::types::attr::SHAPE{}, keypoints));
          for (long  k=0L; k < __target159086064; k += 1L)
          {
